...
namespace UnityTutorial.PlayerControl
{
    public class PlayerController : MonoBehaviour
    {
        ...
        private void Move()
        {
            ...
            {
                _playerRigidbody.AddForce(GetSlopeMoveDirection() * moveSpeed * 20f, ForceMode.Force);
            ...
            else*/ if (_grounded)
            {
                ...
                // for step sounds
                if (_currentVelocity.x > 1 || _currentVelocity.y > 1 || _currentVelocity.x < -1 || _currentVelocity.y < -1)
